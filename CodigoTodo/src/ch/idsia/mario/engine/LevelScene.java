...
// Second solution.
import ch.idsia.mario.engine.second_solution.LevelGeneratorSecondSolution;

// Third solution.
import ch.idsia.mario.engine.third_solution.LevelGeneratorThirdSolution;
...
//                }
    ...
    public void init()
    {
        try
        {
            // Se ha colocado tiles.dat en el ra�z del directorio classes para que funcione correctamente. Se ha cambiado "resources/tiles.dat" por "tiles.dat".
