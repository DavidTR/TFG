...
public class Art
{
    ...
    //final static String img = "C:" + File.separator + "Users" + File.separator + "roka9" + File.separator + "Downloads" + File.separator + "marioai" + File.separator + "img" + File.separator;
    final static String img ="resources/";
...
//            System.out.println(curDir);
    ...
    {
        //System.out.println("ENTRO" + imageName);
